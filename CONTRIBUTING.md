...
- I am new to the community. Where can I find the
  [Ory Community Code of Conduct?](https://github.com/matthewmcneely/dockertest/blob/master/CODE_OF_CONDUCT.md)
...
[list of good first issues](https://github.com/matthewmcneely/dockertest/labels/good%20first%20issue).
...
1. Add a descriptive prefix to commits. This ensures a uniform commit history
   ...
   [list of prefixes for Dockertest](https://github.com/matthewmcneely/dockertest/blob/master/.github/semantic.yml)
   for an overview.
